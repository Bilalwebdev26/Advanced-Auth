...
const VITE_AUTH_API = "http://localhost:3000/api/auth"
...
export const useAuthStore = create((set) => ({
  ...
  checkAuthentication:async()=>{
    ...
    try {
        const response = await axios.get(`${VITE_AUTH_API}/check-auth`,{withCredentials: true })
